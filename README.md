...
This repository contains a simple client-side PGP web app (index.html, script.js, style.css) that uses OpenPGP.js to generate keys, encrypt, decrypt, sign, and verify entirely in the browser. It is[...]

**🔗 [Live Demo](https://rohan-m-kells.github.io/pgponline/)**
...
How to use:
- Open [the live demo](https://rohan-m-kells.github.io/pgponline/) or index.html in a modern browser (Chrome/Firefox/Edge/Safari).
